  ...
  <div class="app-container">
    <el-card class="main-card">
      ...
      <div style="margin-bottom: 10px" class="operation-container">
        <el-input v-model="params.name" prefix-icon="el-icon-search" size="small" placeholder="请输入相册名" style="width:200px"
          @keyup.enter.native="handleFind" />
        <el-button type="primary" size="small" icon="el-icon-search" style="margin-left:1rem" @click="handleFind">
          搜索
        </el-button>
        <el-button v-if="canAdd" type="primary" size="small" icon="el-icon-plus" @click="handleAdd()">
          新建相册
        </el-button>
      ...
      <el-pagination :hide-on-single-page="true" class="pagination-container" @size-change="sizeChange"
        @current-change="currentChange" :current-page="params.pageNo" :page-size="params.pageSize" :total="total"
