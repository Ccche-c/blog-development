    ...
    <aside class="containner">
        <v-card class="box">
            ...
            <div class="user">
                ...
                <span class="desc">{{ $store.state.webSiteInfo.authorInfo }}</span>
                <div class="count">
                ...
                <div class="lianxi">
                    <a :href="$store.state.webSiteInfo.github">
                        <svg-icon icon-class="github" />
                    </a>
                    <a class="gitee" :href="$store.state.webSiteInfo.gitee" target="_blank" title="Gitee"
                    ...
                    <a class="email" :href="'mailto:' + $store.state.webSiteInfo.email" target="_blank" title="邮箱"
                        rel="noopener noreferrer nofollow">
